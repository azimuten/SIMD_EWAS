...
head(mvals_na) #viweing the first 6 lines of the mvals. Rows = CpG, columns = e.g. SLIDE12_R04C01.
...
Sample_Name <- as.character(FOM_subset_samplesheet$Sample_Name)
FOM_mvals <- subset(mvals_na, select = c(Sample_Name))
